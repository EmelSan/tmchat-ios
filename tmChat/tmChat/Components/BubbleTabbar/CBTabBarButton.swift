...
public class CBTabBarButton: UIControl {
    ...
    private let bgHeight: CGFloat = 36
    ...
    private func configureSubviews() {
        ...
        if rightToLeft {
            ...
            tabImage.leadingAnchor.constraint(equalTo: tabBg.leadingAnchor, constant: 16).isActive = true
            tabImage.centerYAnchor.constraint(equalTo: tabBg.centerYAnchor).isActive = true
            ...
            csFoldedBgTrailing = tabImage.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -30)
            csUnfoldedBgTrailing = tabLabel.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -16)
        }
    ...
    private func fold(animationDuration duration: Double = 0.0) {
        ...
        UIView.transition(with: tabImage, duration: duration, options: [.transitionCrossDissolve], animations: {
            self.tabImage.tintColor = .bapAccent
        }, completion: nil)
