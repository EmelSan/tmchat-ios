...
open class BubbleTabBar: UITabBar {
    ...
    private func configure() {
        ...
        container.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -30).isActive = true
...
//        if #available(iOS 11.0, *) {
//            buttons.first?.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor, constant: 16).isActive = true
//            buttons.last?.trailingAnchor.constraint(equalTo: safeAreaLayoutGuide.trailingAnchor, constant: -16).isActive = true
//        }
//
